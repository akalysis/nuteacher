...
const concepts: LogoConcept[] = [
  {
    ...
    mark: (
      <svg viewBox="0 0 360 104" role="img" aria-label="Signal monogram logo option">
        <rect fill="#0f241f" height="104" rx="8" width="360" />
        <rect fill="#135f48" height="72" rx="8" width="72" x="22" y="16" />
        <path d="M34 73V31l18 42 18-42v42" fill="none" stroke="#f8faf7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6" />
        <path d="M28 78c13-2 21-8 30-21 7-10 15-16 28-17" fill="none" stroke="#8fbc9b" strokeLinecap="round" strokeWidth="4" />
        <circle cx="34" cy="76" fill="#8fbc9b" r="3.5" />
        <circle cx="58" cy="57" fill="#8fbc9b" r="3.5" />
        <circle cx="86" cy="40" fill="#8fbc9b" r="3.5" />
        <Wordmark />
      </svg>
    ),
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 360 104" role="img" aria-label="Evidence compass logo option">
        ...
        <path d="M58 31l11 21-11 21-11-21z" fill="#8fbc9b" />
        <circle cx="58" cy="52" fill="#0f241f" r="6" />
  ...
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 360 104" role="img" aria-label="Cohort rings logo option">
        ...
        <circle cx="66" cy="52" fill="none" r="22" stroke="#135f48" strokeWidth="7" />
        <circle cx="38" cy="52" fill="none" r="15" stroke="#0d4a3c" strokeWidth="7" />
        <path d="M25 72c18-2 28-12 39-29 7-11 15-17 27-18" fill="none" stroke="#8fbc9b" strokeLinecap="round" strokeWidth="4" />
        <Wordmark />
      </svg>
    ),
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 360 104" role="img" aria-label="Methods margin logo option">
        ...
        <path d="M42 73c9-18 17-20 24-10 6 8 11 7 18-12" fill="none" stroke="#8fbc9b" strokeLinecap="round" strokeWidth="4" />
        <circle cx="42" cy="73" fill="#8fbc9b" r="3" />
        <circle cx="66" cy="63" fill="#8fbc9b" r="3" />
        <circle cx="84" cy="51" fill="#8fbc9b" r="3" />
        <Wordmark />
      </svg>
    ),
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 360 104" role="img" aria-label="Garden plot logo option">
        ...
        <path d="M58 62c-14-1-24-9-28-23 15 1 24 8 28 23z" fill="#135f48" />
        <path d="M58 49c16-2 26-10 31-25-17 1-27 9-31 25z" fill="#345f84" />
        <path d="M36 72c18-1 34-9 48-25" fill="none" stroke="#8fbc9b" strokeLinecap="round" strokeWidth="4" />
        <circle cx="36" cy="72" fill="#8fbc9b" r="3.5" />
        <circle cx="58" cy="61" fill="#8fbc9b" r="3.5" />
        <circle cx="84" cy="47" fill="#8fbc9b" r="3.5" />
        <Wordmark />
      </svg>
    ),
  },
